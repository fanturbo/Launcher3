...
public interface LauncherLogProto {
  ...
  public static final class Target extends
    ...
    public Target clear() {
      ...
      cardinality = 0;
      controlType = LauncherLogProto.DEFAULT_CONTROLTYPE;
      itemType = LauncherLogProto.DEFAULT_ITEMTYPE;
      packageNameHash = 0;
      componentHash = 0;
      intentHash = 0;
      spanX = 1;
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.containerType != LauncherLogProto.DEFAULT_CONTAINERTYPE) {
        output.writeInt32(6, this.containerType);
      }
      if (this.cardinality != 0) {
        output.writeInt32(7, this.cardinality);
      }
      if (this.controlType != LauncherLogProto.DEFAULT_CONTROLTYPE) {
        output.writeInt32(8, this.controlType);
      }
      if (this.itemType != LauncherLogProto.DEFAULT_ITEMTYPE) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 48: {
            int value = input.readInt32();
            switch (value) {
              case LauncherLogProto.DEFAULT_CONTAINERTYPE:
          ...
          case 64: {
            int value = input.readInt32();
            switch (value) {
              case LauncherLogProto.DEFAULT_CONTROLTYPE:
              ...
              case LauncherLogProto.VERTICAL_SCROLL:
          ...
          case 72: {
            int value = input.readInt32();
            switch (value) {
              case LauncherLogProto.DEFAULT_ITEMTYPE:
  ...
  public static final class Action extends
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
        throws java.io.IOException {
      if (this.type != Action.TOUCH) {
        output.writeInt32(1, this.type);
      }
      if (this.touch != Action.TAP) {
        output.writeInt32(2, this.touch);
      }
      if (this.dir != Action.NONE) {
